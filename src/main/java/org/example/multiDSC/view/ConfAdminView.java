 ...
 * @author Ivan Guerrero Romero, Alvaro Garcia Lopez
 * @version 1.1*/
...
public class ConfAdminView extends JFrame {
    ...
    public ConfAdminView() {
        ...
        for (int i = 0; i < 50; i++) {
            ...
            rowPanel.setBackground(new Color(110,110,110));
        ...
        volverButtonPanel.setBackground(new Color(50, 50, 50)); // Fondo gris oscuro
        ...
        //añado los colores de la ventana para que quede mas bonita


        mainPanel.setBackground(new Color(50, 50, 50)); // Fondo gris oscuro
        fieldsPanel.setBackground(new Color(70, 70, 70)); // Fondo gris medio
        buttonsPanel.setBackground(new Color(30, 30, 30)); // Fondo negro
        //labelsPanel.setBackground(new Color(90, 90, 90)); // Fondo gris claro
        actionButtonsPanel.setBackground(new Color(30, 30, 30)); // Fondo negro
    ...
    public static void main(String[] args) {
        // Crear una instancia de ConfAdminView y hacerla visible
        javax.swing.SwingUtilities.invokeLater(() -> new ConfAdminView());
    }
